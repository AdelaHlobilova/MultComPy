...
ax = image_init()
ax.plot(C2_tr1[1], C2_tr1[0], '-o', color='y', markersize=5,
        label="C2 MultComPy, original variant numpy.fftn", linewidth=1)
ax.plot(C2_tr2[1], C2_tr2[0], '-o', color='r', markersize=5,
        label="C2 MultComPy, switch for autocorr.fun, numpy.fftn", linewidth=1)
ax.plot(C2_tr3[1], C2_tr3[0], '-o', color='g', markersize=5,
        label="C2 MultComPy, scipy.fftn", linewidth=1)
ax.plot(C2_tr4[1], C2_tr4[0], '-o', color='b', markersize=5,
        label="C2 MultComPy, scipy.fftn shorter code", linewidth=1)
image_final()
